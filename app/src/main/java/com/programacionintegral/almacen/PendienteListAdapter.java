...
public class PendienteListAdapter extends BaseAdapter
{
    private Context mContext;
    private List<surtido> mSurtdioList;

    public PendienteListAdapter(Context mContext, List<surtido> mSurtdioList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = View.inflate(mContext, R.layout.item_pendientes, null);
        LinearLayout mlinear = v.findViewById(R.id.linear);

        Integer idSurtido =mSurtdioList.get(position).getId();
        TextView tvfecha=v.findViewById(R.id.tv_fecha);
      ...
      //  CheckBox checkbox =v.findViewById(R.id.checkrecibido);
        ...
        tvfecha.setText(mSurtdioList.get(position).getFecha());
